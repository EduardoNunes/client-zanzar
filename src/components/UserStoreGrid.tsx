import { FileImage, PackagePlus } from "lucide-react";
...
export default function UserStoreGrid({ username, productFeePercentage, userStoreId }: UserStoreGridProps) {
  ...
  return (
    <div>
      {isOpen && <AddProduct productFeePercentage={productFeePercentage} userStoreId={userStoreId} />}
      <button className="w-9 h-9" onClick={handleAddProduct}>
